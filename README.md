...
At the end of all this process, this exercise helps us to apply and practice with diferent techniques and methodology learnt to obtain, manage, analice and project data. Sometimes the data was difficult to get, or you had to find the way to build it.  
